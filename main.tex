...
Após a avaliação de resultados gerados conseguimos obter a acurácia de $81\%$. Como indicado na Figura \ref{fig:graph}, a precisão do modelo alcança o pico de 1.00 quando a confiança está em 0.882. Concomitamentemente, o recall atinge seu valor mínimo de 0 quando confiança bate 0.96.

Ao se observar o balanço entre os gráficos de {\it precision} e {\it recall} entende-se que as detecções relevantes estão até o nível de confiança $0.7$, a partir daí o {\it recall} decai de forma expressiva indicando que o modelo já não mais apresenta assertividade em suas detecções.
