...
Para o processo de treinamento foram utilizadas 31 imagens com anotações de tumores malignos, este que se deu em 250 épocas com {\it batch size} de 16 imagens, valores estes arbitrários com embasamento em exemplos da literatura. Devido ao tamanho diminuto do {\it dataset} utilizado para o treinamento, foi-se utilizada a técnica de transferência de aprendizagem a partir do conjunto de pesos pré-treinados YOLOv5s \cite{glenn_jocher_2022} como é recomendado pela própria documentação oficial da arquitetura.
