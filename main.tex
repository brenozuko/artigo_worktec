...
Seres humanos são capazes de detectar objetos em tempo real, sua posição no espaço e papel representado no ambiente com velocidade e eficiência. Sistemas que propõem emular tais resultados necessitam.
...
histopatológicas de 1098 pacientes com câncer de mama e suas respectivas imagens histológica \cite{tiezzi2020}. Posteriormente, como é requisitado pelo YOLO \cite{Redmon2015} em sua arquitetura, os tumores presentes em cada imagem que participaria do sub-conjunto de treino foram anotados para que sejam reconhecidos pelo modelo.
