...
Após a avaliação de resultados gerados conseguimos obter a partir da matriz de confusão a acurácia de 81\%, o que é bastante satisfatório. Não obstamte, é preciso levar em consideração algumas outras métricas para a compreensão completa das limitações 
